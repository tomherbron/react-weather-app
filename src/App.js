...
function App() {
  ...
  useEffect(() => {
      const fetchWeather = async () => {
          ...
          toast.info('Fetching weather for ' + message[0].toUpperCase() + message.substring(1) + "...");
  ...
  return (
    <div className={`mx-auto max-w-screen-md mt-4 py-5 px-32
        bg-gradient-to-br from-cyan-700 to-blue-700 h-fit shadow-xl shadow-gray-400 mb-5 ${formatBackground()}`}>
